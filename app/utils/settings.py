...
DB_URI: str = (
    f"mongodb://{DB_USSERNAME}:{DB_PASSWORD}@leomongoPrimary:28021,leomongoSecondary:28022,leomongoTertiary:28023/?replicaSet={RS_NAME}&authMechanism=DEFAULT"
)
